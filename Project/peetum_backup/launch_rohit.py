...
hostfile = "/proj/cs744-PG0/bosen_config/fourhosts"
#join(proj_dir, "machinefiles", hostfile_name)
...
params = {
    "train_file": join(app_dir, "/proj/cs744-PG0/dm1/mnist8m")
    , "test_file": join(app_dir, "/proj/cs744-PG0/dm1/mnist8m_test")
    , "global_data": "false"
    , "perform_test": "true"
